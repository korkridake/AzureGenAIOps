...
class AzureDataLoader:
    ...
    def download_blob(self, container_name: str, blob_name: str, local_path: Path) -> None:
    ...
    def upload_blob(self, container_name: str, blob_name: str, local_path: Path) -> None:
